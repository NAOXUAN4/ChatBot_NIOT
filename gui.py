...
class MyApp:
    def __init__(self):
        ...
        self.FontDic = {1: "color: #1491A8; font-size: 20px; font-weight: bold; font-family:",
                        2: "color: #61649f; font-size: 20px; font-weight: bold;",
                        3: "color: #f17666; font-size: 20px; font-weight: bold;"}
        """字体仓库"""
    ...
    def tTsResSWi(self):
        ...
        if self.resultGLM != "":
            ...
            with open("E:\py_project\ChatCLM+genshinTTS/audio/Tmp.mp3", "wb") as f:
